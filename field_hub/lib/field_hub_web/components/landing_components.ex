  ...
  def header(assigns) do
    ...
    <!-- Desktop Menu -->
          <div class="hidden md:flex items-center gap-8">
            <a
              href="#features"
              class="text-sm font-medium text-[rgb(var(--muted))] hover:text-[rgb(var(--fg))] transition-colors"
            >
              Features
            </a>
            <a
    ...
    <!-- Right actions -->
          <div class="flex items-center gap-3">
            ...
            >
              <svg
                id="sunIcon"
                class="w-4 h-4 hidden [data-theme=dark]:inline text-[rgb(var(--muted))]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <svg
                id="moonIcon"
                class="w-4 h-4 [data-theme=light]:inline hidden dark:hidden text-[rgb(var(--muted))]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <svg
                id="moonIconSimple"
                class="w-4 h-4 text-[rgb(var(--muted))] dark-hidden-logic"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <div class="flex flex-col items-end mr-2">
                ...
                <div class="flex gap-3">
                  ...
                  <a
                    ...
                    class="hidden sm:block text-xs font-bold text-[rgb(var(--muted))] hover:text-[rgb(var(--fg))] transition-colors"
                  >
                    Settings
                  </a>
                  <.link
            ...
            <% else %>
              <a
                href="/users/log-in"
                class="hidden sm:block text-sm font-semibold text-[rgb(var(--muted))] hover:text-[rgb(var(--fg))] transition-colors"
              >
                Log in
              </a>
            <% end %>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <div class="text-sm text-[rgb(var(--muted))]">
                Dispatch and field execution, unified.
              </div>
            </div>
          </div>
