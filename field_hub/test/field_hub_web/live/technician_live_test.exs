defmodule FieldHubWeb.TechnicianLiveTest do
  ...
  @create_attrs %{name: "New Tech", email: "newtech@example.com", phone: "555-0000", hourly_rate: "45.00", color: "#aabbcc"}
  ...
  describe "Index" do
    ...
    test "saves new technician", %{conn: conn} do
      ...
      assert index_live
           |> form("#technician-form", technician: Map.put(@create_attrs, :skills_input, "HVAC, Plumbing"))
           |> render_submit()
  ...
  test "updates in real-time", %{conn: conn, org: org} do
    ...
    # Test Create
    {:ok, tech} = Dispatch.create_technician(org.id, %{
      name: "Real-time Tech",
